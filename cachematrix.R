...
## It first checks to ensure that the inverse has already been calculated. 
## If it hasbeen calculated, it gets the inverse from the cache and skips the computation. 
## Then, it calculates the inverse of the data and sets the value of the inverse in the cache via 
